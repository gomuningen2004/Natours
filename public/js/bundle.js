(() => {
  ...
  function displaMap(locations) {
    ...
    locations.forEach((loc) => {
      ...
      points.push(latlng);
      L.marker(latlng, { icon: greenIcon }).addTo(map).bindPopup(`<p>Day ${loc.day}: ${loc.description}</p>`, {
        autoClose: false,
        className: "mapPopup"
  ...
  var logoutBnt = document.querySelector(".nav__el--logout");
